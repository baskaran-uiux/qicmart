...
export async function POST(req: Request) {
    try {
        ...
        const { storeId, isStorefrontDisabled, isAdminPanelDisabled, planName, billingCycle, expiryDate, aiCredits } = body
        ...
        if (typeof aiCredits === 'number') updateData.aiCredits = aiCredits
