...
import { User, Mail, Phone, Upload, Check, Loader2, Save } from "lucide-react"
...
export default function ProfilePage() {
    ...
    if (loading) return (
        <div className="flex flex-col items-center justify-center h-96 gap-4 text-zinc-500">
            ...
            <p className="font-medium tracking-tight">Loading profile...</p>
        </div>
    )
        ...
        <div className="max-w-6xl mx-auto space-y-8 animate-fade-in">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6 pb-6 border-b border-zinc-100 dark:border-zinc-800">
                ...
                <button
                    onClick={handleSave}
                    disabled={saving}
                    className={`group flex items-center justify-center gap-3 px-8 sm:px-12 py-3.5 rounded-2xl text-[10px] font-semibold capitalize tracking-wide transition-all shadow-xl active:scale-95 ${
