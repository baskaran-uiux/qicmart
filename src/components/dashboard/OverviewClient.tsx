        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="bg-white dark:bg-zinc-900 rounded-[32px] border border-zinc-200 dark:border-zinc-800 p-8 shadow-sm flex flex-col sm:flex-row items-center gap-8 group">
                ...
                <div className="flex-1 flex flex-col items-center sm:items-start text-center sm:text-left">
                    <div className="mb-6">
                        <h3 className="text-xl font-black text-black dark:text-white uppercase tracking-tight italic mb-2">Store QR Code</h3>
                        <p className="text-zinc-500 dark:text-zinc-400 text-sm font-medium">Scan to visit your digital empire or share it with your customers globally.</p>
                    </div>
            ...
            <div className="bg-indigo-600 rounded-[32px] p-8 shadow-2xl relative overflow-hidden group border border-indigo-400/20">
                ...
                <div className="relative z-10 h-full flex flex-col">
                    <div className="flex justify-between items-start mb-8">
                        <div>
                            <h3 className="text-3xl font-black tracking-tighter italic uppercase text-white mb-2 leading-none">Empire Status</h3>
                            <p className="text-indigo-100/70 text-sm font-medium tracking-tight">Your store is globally active and live.</p>
                        </div>
                    ...
                    <div className="grid grid-cols-2 gap-4 mt-auto">
                        <div className="p-6 bg-white/10 backdrop-blur-md rounded-[24px] border border-white/10">
                            <p className="text-[10px] font-black uppercase tracking-widest text-indigo-100/50 mb-1">Sales Goal</p>
                        ...
                        <div className="p-6 bg-white/10 backdrop-blur-md rounded-[24px] border border-white/10">
                            <p className="text-[10px] font-black uppercase tracking-widest text-indigo-100/50 mb-1">Store Health</p>
                            <div className="flex items-center justify-between">
                                <p className="text-xl font-black text-white">Excellent</p>
                                <CheckCircle size={16} className="text-white" />
                            </div>
                            <p className="text-[8px] font-bold text-white/40 mt-3 uppercase tracking-widest">Everything is perfect</p>
                        </div>
                    </div>
                </div>
            </div>
